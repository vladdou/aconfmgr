...
function arch_HaveOrphanPackages() {
	"$PACMAN" --query --unrequired --unrequired --deps --quiet > /dev/null
}

function arch_PruneOrphanPackages() {
...
function arch_FindModifiedFiles() {
	AconfNeedProgram paccheck pacutils y 1>&2
